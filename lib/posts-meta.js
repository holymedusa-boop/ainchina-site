...
const allPosts = [
  ...
  },
  {
    ...
    category: 'AI Trends',
    excerpt: "The Politburo's 'AI+ Action' directive, CAICT's ¥449B market forecast, and DeepSeek V4's agent architecture converge to mark China's inflection point from chatbots to autonomous AI workers.",
    date: '2026-05-01',
    readTime: '17 min read'
  },
  {
