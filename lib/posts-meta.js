...
const allPosts = [
  ...
  },
  {
    ...
    category: 'AI Trends',
    excerpt: "MiniMax earned 73% of its revenue from overseas markets in 2025, with ARR hitting $150M. Its AI companion app Talkie commands 70 minutes of daily user attention — nearly matching TikTok. And its API costs one-tenth of American competitors. This is the story of how Chinese AI cracked the global code.",
    date: '2026-05-21',
    readTime: '16 min read'
  },
  {
    ...
    category: 'AI Trends',
    excerpt: "Xiaohongshu searches for 'AI interview coaching' surged 120% in one week. Six hundred eighty thousand user posts. One hundred eighty million views. And a generation of Chinese graduates who refuse to face the 2026 job market unarmed.",
    date: '2026-05-20',
    readTime: '16 min read'
  },
  {
    ...
    category: 'AI Infrastructure',
    excerpt: "Cambricon Q1 net profit 1.013 billion yuan (+185%), cash flow turned positive at 834 million yuan. Hygon revenue 4.034 billion yuan (+68%), DCU revenue 1.414 billion yuan (+120%). Moore Threads achieved quarterly profitability for the first time. Domestic GPU cloud market share hit 41% — an all-time high. The quarter that proved China's AI chip industry has reached escape velocity.",
    date: '2026-05-19',
    readTime: '16 min read'
  },
  {
    ...
    excerpt: "With 250 million Xiaohongshu views in one week, China's office workers are abandoning manual slide design. WPS AI and iSlide AI generate boardroom-ready presentations in under 3 minutes — at prices 90% below Western alternatives. Inside the productivity inflection point Silicon Valley is underestimating.",
    date: '2026-05-18',
    readTime: '16 min read'
  },
  {
    ...
    category: 'AI Safety',
    excerpt: "91.5% of Chinese AI users cannot reliably detect when a large language model is hallucinating. 70+ government servers deploy DeepSeek unprotected. China's AI trust crisis.",
    date: '2026-05-17',
    readTime: '16 min read'
  },
  {
    ...
    category: 'AI Applications',
    excerpt: "DeepSeek opened to external investors at $45-50B valuation. Kimi closed a $2B round at $20B valuation. AI-driven digital humans and creator tools have turned 48 million Chinese content creators into a monetization machine.",
    date: '2026-05-16',
    readTime: '16 min read'
  },
  {
    ...
    excerpt: "In a single week, China's AI startup valuations jumped by over $100 billion. DeepSeek went from $10B to $50B. Kimi locked in $2B fresh capital. And the entire 'Six Little Tigers' cohort is racing toward IPO.",
    date: '2026-05-15',
  ...
  },
  {
    ...
    category: 'AI Policy',
    excerpt: "On April 28, 2026, China's Politburo elevated compute networks to national strategic infrastructure—on par with water and power. The Six Networks blueprint commits 7+ trillion yuan annually, with the compute network receiving over 1 trillion yuan. Here's what happens when a superpower decides AI infrastructure is civilization-critical.",
    date: '2026-05-14',
    readTime: '17 min read'
  },
  {
    ...
    excerpt: "While the world watched ChatGPT, China's AI apps hit 2.5B users. Doubao reached 100M DAU. MiniMax serves 200+ countries. Inside the invisible consumer AI empire that the Western tech media barely covers.",
    date: '2026-05-13',
    readTime: '16 min read'
  },
  {
    ...
    excerpt: "Kimi raises $20B at $200B valuation. DeepSeek valued at $450B. Chinese open-source models now dominate the global top 5. With $65B+ in fresh capital and 140 trillion daily tokens, China's AI industry has entered its 'God of War' era.",
    date: '2026-05-12',
    readTime: '16 min read'
  },
  {
    slug: 'deepseek-73b-megaround-china-ai-funding-frenzy',
    title: "DeepSeek's $7.3B Mega-Round: China's AI Funding Frenzy Hits Historic Heights",
    category: 'AI Industry',
    excerpt: "DeepSeek seeks $7.35B in China's largest AI funding round ever. Founder Liang Wenfeng puts in $2.9B of his own money. Moonshot AI hits $20B valuation. InfiniGence AI raises $700M+ for AI infrastructure. And Redis creator antirez builds a dedicated inference engine for DeepSeek V4. May 2026 is the month China's AI industry went all-in.",
    date: '2026-05-11',
    readTime: '17 min read'
  },
  {
    ...
    category: 'AI Policy',
    excerpt: "Three Chinese ministries issued the first national AI agent policy with 19 application scenarios. GB/Z 177—2026 established L1–L4 terminal intelligence grading. Anthropic nears $1 trillion valuation. And China Mobile opened a trillion-token service package. May 2026 will be remembered as the month agents went mainstream.",
    date: '2026-05-10',
    readTime: '17 min read'
  },
  {
