...
- [Qwen: The Billion-Download Model Powering China's Open-Source AI Revolution](/blog/qwen-billion-downloads-china-open-source-ai-dominance-2026) — How Alibaba's Qwen model family became the most widely adopted open-weight AI ecosystem in China, with over 90,000 derivative models and a global developer community.
- [Tongyi Qianwen: Alibaba's AI Platform](/blog/tongyi-qianwen-alibaba) — A deep dive into Alibaba's Tongyi Qianwen platform, the foundation of the Qwen model family and the infrastructure powering China's enterprise AI adoption.
- [Wenxin Yiyan: Baidu's AI Platform](/blog/wenxin-yiyan-baidu) — An analysis of Baidu's Ernie model and Wenxin Yiyan platform, the second domestic partner in Apple's China AI architecture and a key player in search-integrated AI.
- [Kimi K3: Moonshot's 2.5 Trillion-Parameter Open-Source AI](/blog/kimi-k3-moonshot-2-5-trillion-open-source-ai-2026) — While Apple partners with Alibaba for on-device AI, Moonshot AI's open-source Kimi K3 represents the other frontier: China's race to build the world's largest open-weight models.
- [Meituan LongCat-2.0: China's First Trillion-Parameter Model Trained on Domestic Chips](/blog/meituan-longcat-2-trillion-domestic-chips-china-ai-independence-2026) — The story of how Meituan built a competitive open-source model entirely on Chinese hardware, proving that chip independence is not just possible but practical.
- [MiniMax: From 300 Million Users to A-Share IPO](/blog/minimax-300m-users-arr-doubles-a-share-ipo-china-ai-export-2026) — How MiniMax built a global AI companion empire with 300 million users and doubled its ARR, representing China's AI export strategy beyond hardware partnerships.
