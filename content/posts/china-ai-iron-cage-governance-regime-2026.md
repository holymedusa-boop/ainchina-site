...
| Pillar | Regulation | Effective Date | Scope | Registration Timeline | Maximum Penalty |
|---|---|---|---|---|---|
| **Pillar I** | Algorithm Recommendation Regulations | March 2022 | All recommendation engines (news feeds, e-commerce, search, social media) | 30 days post-launch or major update | ¥1 million (~$140,000) + license suspension |
| **Pillar II** | Deep Synthesis Provisions | January 2023 | All synthetic media (deepfakes, AI-generated images, video, audio) | 15 days post-launch | ¥5 million (~$700,000) + platform shutdown + criminal liability |
| **Pillar III** | Generative AI Interim Measures | August 2023 | All LLMs, image generators, and content-creation systems | 45 days post-training | Fines up to 10% of annual revenue + service ban + criminal charges |
...
Users were granted rights that Western platforms were only beginning to discuss. Every user had to be able to disable algorithmic recommendations entirely and view content in chronological order. Platforms had to provide explanations for significant algorithmic decisions—why a particular piece of content was recommended, or why a user's content was demoted. Most strikingly, the regulations prohibited algorithms that "induced users to become addicted" or "over-consume," explicitly targeting the engagement-optimization logic that powers most Western social media business models.
...
The 45-day filing requirement created a compliance bottleneck that shaped the entire Chinese generative AI market. Foreign developers like OpenAI could not simply release a model in China via API. They needed a Chinese legal entity, local infrastructure, registered algorithms, and approved content filters. The timeline from model completion to public launch stretched to six months or more. For domestic developers, the registration process became a competitive moat: companies that built compliance infrastructure early, like Baidu and Alibaba, could launch models faster than startups that were still assembling their regulatory teams.
...
The result is a market structure that differs fundamentally from the United States. In the U.S., AI companies launch first and address regulatory questions later, often through post-hoc litigation or voluntary industry standards. In China, launch is the final step of a months-long regulatory process. The advantage is predictability: companies know exactly what is required and can build for compliance from day one. The disadvantage is barrier to entry: the cost of compliance is high enough to exclude smaller players and foreign competitors who cannot afford a year-long pre-launch phase.
...
|---|---|---|---|
| **Philosophy** | Comprehensive control; state security and ideological alignment | Risk-based tiering; fundamental rights protection | Sector-specific; innovation-first, reactive |
| **Scope** | All recommendation algorithms, all synthetic media, all generative AI | High-risk applications only; open-source exempted | No comprehensive federal law; FTC, FDA, NIST guidelines |
| **Pre-launch** | Mandatory registration and approval before launch | Conformity assessment for high-risk AI; others self-certify | No pre-market approval; post-hoc enforcement |
| **Content rules** | Must align with "socialist core values"; political dissent banned | Must comply with EU Charter; hate speech prohibited | Section 230 protects platforms; limited content rules |
| **Data localization** | Mandatory; cross-border transfers require CAC assessment | GDPR allows transfers with safeguards; no localization mandate | No federal localization requirement |
| **Real-name verification** | Mandatory for all AI services | GDPR limits data collection; no real-name mandate | No federal real-name requirement |
| **Open-source** | No exemption; all accessible models must comply | Explicitly exempted from highest-risk tier | No specific open-source rules |
| **Penalties** | ¥5 million + license suspension + criminal liability (up to 7 years) | Up to 7% of global annual turnover | FTC fines; state-level litigation; no criminal AI penalties |
| **Enforcement agency** | CAC, MIIT, NDRC, Public Security Bureau | National market surveillance authorities | FTC, FDA, SEC (sector-specific) |
| **Appeal process** | Administrative review; no independent judicial appeal | Judicial review available in EU courts | Full judicial review available |
...
The EU's risk-based approach is more nuanced but also more porous. By exempting open-source models and focusing only on high-risk applications, it leaves large swaths of the AI ecosystem unregulated. The U.S. approach is even more fragmented, with no comprehensive federal law and enforcement scattered across the FTC, FDA, SEC, and state attorneys general. China's comprehensive approach is less discriminating but also less leaky. There are no gaps in the regulatory net. Every algorithm, every generated image, and every model is covered.

The trade-off is innovation velocity. China's pre-launch approval process adds months to development timelines and significant compliance costs. The EU's conformity assessment creates similar delays for high-risk applications but leaves low-risk innovation untouched. The U.S. approach minimizes regulatory friction but also minimizes consumer protection. There is no globally optimal framework—only different national choices about the balance between control and innovation.
